...
var splashActivityProcessor = require('./splash_activity');
...
const processUpdates = (payload, strategy) =>
	new Promise((resolve, reject) => {
		...
		resolve(
			strategy.utils
				.checkPath(strategy.fileSystem, payload.projectPath, true)
				.then((basePath) => {
		...
		.then((androidValidProjectPath) =>
			Promise.all([
				...
				splashActivityProcessor.process(androidValidProjectPath, payload, strategy), // process android Main App file
