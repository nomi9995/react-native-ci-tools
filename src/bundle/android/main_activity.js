const mainActivityDefaultPathPattern = 'app/src/main/java/com/developer/arsltech/github/MainActivity.java';
...
const process = (androidProjectValidPath, payload, strategy) => {
	...
	return strategy.utils
		.globSearch(strategy.globber, mainActivityPathPattern, false)
